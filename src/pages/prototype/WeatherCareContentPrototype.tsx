...
import { ArrowLeft, Clock, Edit3, Eye, Heart, Users } from "lucide-react";
import {
...
const scenarios: {
...
}[] = [
  {
    ...
    trigger: {
      ...
      ) as WeatherTriggerState["enabled"],
  ...
  },
  {
    ...
    contents: {
      ...
      rainstorm: { selected: aiWeatherContentVariants.rainstorm[0] },
    },
  },
  {
    id: "full",
    ...
    contents: Object.fromEntries(
      weatherTriggerCategories.map((c) => [
        c.key,
        { selected: aiWeatherContentVariants[c.key][0] },
      ]),
    ) as WeatherContentMap,
  },
];
...
const WeatherCareContentPrototype = () => {
  ...
  const [contents, setContents] = useState<WeatherContentMap>(scenarios[1].contents);
